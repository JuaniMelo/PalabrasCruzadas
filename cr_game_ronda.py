...
#INITS
    ...
    def init_layout(self):
        ...
        self.titulo = ColorLabel(text=f'PALABRAS CRUZADAS: {self.nivel}', color=(.7, 0, .3, 1), font_name=self.FUENTE, font_size=50, size_hint=(1, .17))
        self.raiz.add_widget(self.titulo)
        self.lbl_pista = ColorLabel(text='',color=(.7,.5,0,1),font_name=self.FUENTE, font_size=25, size_hint=(1, .3))
